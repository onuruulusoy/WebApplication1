...
namespace WebApplication1
{
    public partial class AdminPaneli : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand sorgu = new SqlCommand("Select* from kullanici where kullanici_adi=@user and sifre=@password and admin=admin", wcb);
            ...
            {
                Session["kullanici_id"] = oku["kullanici_id"].ToString();
                Session["admin"] = oku["admin"].ToString();
                //Session["kullanici_adi"] = oku["kullanici_adi"].ToString();
                Response.Redirect("~/Admin/AdminUrun.aspx");
