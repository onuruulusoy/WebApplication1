<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminGirisi.aspx.cs" Inherits="WebApplication1.AdminPaneli" %>
...
<body class="text-center">
    <main class="form-signin">
        <form id="form1" runat="server">           
            ...
            <asp:Button ID="Button2" runat="server" Text="Kullanıcı Girişi Yap" class="w-100 btn btn-lg btn-info" OnClick="Button2_Click"  />
