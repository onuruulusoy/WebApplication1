<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Kategori.aspx.cs" Inherits="WebApplication1.Kategori" %>
    ...
    <!-- Close Banner -->
        ...
        <div class="row text-center pt-5 pb-3">
            <div class="col-lg-6 m-auto">
                <h1 class="h1">Ürünlerimiz</h1>
            </div>
        </div>
<%--        <div class="b-example-divider"></div>--%>
       

        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:dbcs %>" SelectCommand="SELECT * FROM [urunler] WHERE ([urun_katagori] = @urun_katagori)">
            <SelectParameters>
                <asp:QueryStringParameter Name="urun_katagori" QueryStringField="urun_katagori" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
