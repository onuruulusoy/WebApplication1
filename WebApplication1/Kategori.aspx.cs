...
namespace WebApplication1
{
    public partial class Kategori : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string id = Request.QueryString["urun_katagori"];
            SqlCommand sorgu = new SqlCommand("select * from urunler where urun_katagori=@id ", wcb);
            sorgu.Parameters.AddWithValue("@urun_katagori", id);
